...
export class UpdateStorageComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.storageToBeUpdated) {
      ...
      this.storageForm.controls['StorageTSpace'].setValue(this.storageToBeUpdated.StorageTSpace);
      this.storageForm.controls['StorageRSpace'].setValue(this.storageToBeUpdated.StorageRSpace);
    }
  }
